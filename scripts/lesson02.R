...
plotData = ggplot( data=packageData ) +  ## plotData is a list variable
  geom_point( mapping=aes(x=Date, y=Packages) ) +## mapping describes what data gets represented on the plot
